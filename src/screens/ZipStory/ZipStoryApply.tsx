...
const ImageApply = () => (
    <View style={{flex: 1}}>
        <View style={{marginTop: hp('2%')}}>
            <Text style={{marginLeft: wp('6%'), marginTop: hp('2%'), color: '#797979'}}>ZIP 스토리 제목</Text>
            <TextInput style={{width: wp('87%'), height: hp('8%'), borderBottomWidth: 1, borderBottomColor: '#797979', alignSelf: 'center', fontSize: scale(14)}} />
        </View>
        <View style={{marginTop: hp('2%')}}>
            <Text style={{marginLeft: wp('6%'), marginTop: hp('2%'), color: '#797979'}}>내용</Text>
            <TextInput style={{width: wp('87%'), height: hp('8%'), borderBottomWidth: 1, borderBottomColor: '#797979', alignSelf: 'center', fontSize: scale(14)}} />
        </View>
        <View style={{marginTop: hp('2%')}}>
...
export default class ZipStoryApply extends React.Component<{}, State> {
  ...
  render() {
    return (
      <SafeAreaView style={{flex: 1, backgroundColor: '#FFF'}}>
        <StackNavigation status={true} title={'ZIP 스토리 작성'} />
        <TabView
